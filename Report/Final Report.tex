...
\subsection{Buffers}
A pipeline stage might need need more than the vertex data, to calculate the output.
...
Everytime more than a single value is required, the function has to return a struct with the data. In the example, the new position and the input color are passed to the next stage.
